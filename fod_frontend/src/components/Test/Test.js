...
export default function Test() {
  ...
  return (
    <>
      <Container
        className="flex ml-4 align-items-center justify-content-center"
        ...
        <Row>
          <Col xs={12} md={3}>
            ...
            <div className={`${classes.container} ${classes.font}`}>
              ...
              {/*Change me for dynamic text*/}
              <p className={`${classes.infotext}`}>
                420 69st Scranton, New York 16996{" "}
              </p>
              ...
              <p className={`${classes.infotext}`}>
                I'mma hyuck you up, and fill you up with my charitable meat!{" "}
              </p>
            </div>
            <Button className={`w-100 ${classes.profilebutton}`}>
              Edit Profile
            </Button>
          </Col>
          <Col className="ml-3" xs={12} md={7}>
            <Row>
              <div className="w-100 align-items-center justify-content-center">
                <h6
                  className={`${classes.font} m-3 mb-2`}
              ...
              <div className={`${classes.container} ${classes.font}`}>
                {/* Insert carousel */}
                <a
                  className={`m-3 align-items-center m-2 ${classes.favbox}`}
                  href="/profile"
                >
                  {/*Change href to dynamic*/}
                  <img
                    alt="profile-pic"
                    className={`m-3 rounded-circle d-inline-block ${classes.favimg}`}
                    src={imgUrl}
                  />
                </a>
              </div>
            ...
            <Row>
              <div className="w-100 align-items-center justify-content-center">
                <h6
                  className={`${classes.font} m-3 mt-4`}
                  style={{ textAlign: "center" }}
                >
                  Recent blah blah
                </h6>{" "}
              ...
              <div
                className={`${classes.container} ${classes.font}`}
                style={{ minHeight: "55vh" }}
              >
                <div className={`${classes.postings} ${classes.font}`}></div>

                <div
                  className={`${classes.postsection} ${classes.font} align-items-center justify-content-center`}
                >
                  <Row>
