...
function Desktop3(props) {
  const { desktop3, image4, image8, image7, search, vector2, login, findHelp, place, signUp, contactUs, image9, image10, image5, image14, image6, image11, rectangle25, image13, image12, component1Props } = props;
...
function Component1(props) {
  ...
  return (
    <div className="component-1" style={{ backgroundImage: `url(${component1})` }}>
      ...
      <div className="x">
        <img className="vector-3" src="https://anima-uploads.s3.amazonaws.com/projects/607ba672c8a9f11a51cb9679/releases/607c7b624b84add35d07f13a/img/vector-3@2x.svg" />
